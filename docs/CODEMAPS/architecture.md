...
└── docs/
    ...
    ├── manifesto.md                     nine open questions the framework leaves unanswered
    ...
    ├── adr/                             21 ADRs (English) + 21 mirrors (.ja.md) + README + README.ja
...
| Open questions | `docs/manifesto.md` | Nine open questions. Adopters invited to extend. |
...
| AI relationship map | `graph.jsonld` | schema.org JSON-LD. Three axes + four layers + twenty-one ADRs + sibling lines + disjoint-vocabulary edge to AAP. |
...
```
thesis.md ──────► (cited by) ─► all 21 ADRs
