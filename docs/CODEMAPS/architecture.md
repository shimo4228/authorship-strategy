...
└── docs/
    ...
    ├── adr/                             22 ADRs (English) + 22 mirrors (.ja.md) + README + README.ja
...
| AI relationship map | `graph.jsonld` | schema.org JSON-LD. Three axes + four layers + twenty-two ADRs + sibling lines + disjoint-vocabulary edge to AAP. |
...
```
thesis.md ──────► (cited by) ─► all 22 ADRs
