...
└── docs/
    ...
    ├── adr/                             14 ADRs (English) + 14 mirrors (.ja.md) + README + README.ja
...
| AI relationship map | `graph.jsonld` | schema.org JSON-LD. Three axes + four layers + fourteen ADRs + sibling lines + disjoint-vocabulary edge to AAP. |
...
```
thesis.md ──────► (cited by) ─► all 14 ADRs
