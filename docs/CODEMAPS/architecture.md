<!-- Generated: 2026-07-04 | Files scanned: project root + docs/ tree + scripts/ | Token estimate: ~1500 -->
...
| AI relationship map | `graph.jsonld` | schema.org JSON-LD. Three axes + four layers + twenty ADRs + sibling lines + disjoint-vocabulary edge to AAP. |
