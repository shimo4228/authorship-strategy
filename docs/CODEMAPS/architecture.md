<!-- Generated: 2026-05-18 | Files scanned: project root + docs/ tree | Token estimate: ~1500 -->
...
└── docs/
    ...
    ├── adr/                             7 ADRs (English) + 7 mirrors (.ja.md) + README + README.ja
...
| Lineage | `docs/inspiration.md` | Prior literature (Foucault, Chartier, Shapiro & Varian, Lessig, scientometrics, GEO); sibling-line origins of the seven ADRs. |
| ADR index | `docs/adr/README.md` | Seven ADRs grouped: identifier-federation triplet (0001-0003) + maintenance-discipline pair (0004-0005) + LLM-first ingest decision (0006) + metric-rejection decision (0007). |
...
| AI relationship map | `graph.jsonld` | schema.org JSON-LD. Three axes + four layers + seven ADRs + sibling lines + disjoint-vocabulary edge to AAP. |
